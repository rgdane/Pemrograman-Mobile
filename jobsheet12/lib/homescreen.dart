...
const String apiKey = "aba4a73feee9ee67f44e67644e526311";
          ...
          child: Visibility(
            ...
            child: Column(
              children: [
                ...
                // Weather Data
                buildWeatherCard(
                    'Temperature', '${temp?.toInt()} ºC', 'temperature.png'),
                buildWeatherCard('Pressure', '$press hPa', 'pressure.png'),
                buildWeatherCard('Humidity', '$hum %', 'humidity.png'),
                buildWeatherCard('Cloud Cover', '$cover %', 'cloud.png'),
              ],
            ),
          ),
        ),
